...
$messages = require dirname(__DIR__, 2).'/vendor/laravel/framework/src/Illuminate/Translation/lang/en/validation.php';
...
return array_replace_recursive($messages, [
    ...
    'ascii' => 'Le champ :attribute doit contenir uniquement des caractères alphanumériques et symboles codés sur un octet.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Le champ :attribute indiqué figure dans une fuite de données. Veuillez en choisir un autre.',
    ],
